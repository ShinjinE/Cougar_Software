...
const int pwmPIN[]={2,4,7,8,12}; // an array to identify the PWM input pins (the array can be any length) 
...
int RC_min[5] = { 960,    960,    960,    1000,   1000};
int RC_mid[5] = { 1480,   1480,   1480,   1500,   1500};
int RC_max[5] = { 1964,   1960,   1964,   2008,   2008};

// fail safe positions

float RC_failsafe[] = {0.00, 0.00, 0.00, 0.00, -1};
